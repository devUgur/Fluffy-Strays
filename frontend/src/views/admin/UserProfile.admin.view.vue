...
<script>
import UserProfileImageComponent from "@/components/admin/user/user-profile/UserProfileImage.component.vue";
import UserPersonalDetailsComponent from "@/components/admin/user/user-profile/UserPersonalDetails.component.vue";
import UpdateUserButtonComponent from "@/components/admin/user/user-profile/UpdateUserButton.component.vue";
export default {
